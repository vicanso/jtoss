    ...
    */
    ...
    UTIL.prototype.request = function(options, cbf) {
      ...
      return async.waterfall([
        function(cbf) {
          var _ref;
          if ((method === 'PUT' || method === 'POST') && options.body && ((_ref = options.headers) != null ? _ref['Content-Encoding'] : void 0) === 'gzip') {
            return zlib.gzip(options.body, function(err, data) {
              if (err) {
                return cbf(err);
              } else {
                options.body = data;
                return cbf(null, options);
              }
            });
          } else {
            return cbf(null, options);
          }
        }, function(options, cbf) {
          return request(options, cbf);
        }, function(res, body, cbf) {
          var err;
