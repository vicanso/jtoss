(function() {
  var Client, UTIL, async, fs, jtfs, noop, path, xml2js, zlib, _;
    ...
    Client.prototype.getBucketAcl = function(bucket, cbf) {
      ...
      async.waterfall([
        function(cbf) {
          ...
          return cbf(null, data.AccessControlPolicy.AccessControlList[0].Grant[0]);
        }
      ], cbf);
      return this;
    };
      ...
      async.auto({
        ...
        check: [
          'checkData', function(cbf) {
            ...
            return _this.util.getETag(srcObj.zipData, function(err, etag) {
              if (err) {
                return updateCbf(err);
              } else {
