(function() {
  var Client, DEFAULT_ACL, DEFAULT_CONTENT_TYPE, GB_SIZE, KB_SIZE, LARGE_FILE_SIZE, MB_SIZE, OSS_MAX_RESULT_OBJECTS, PROVIDER, UTIL, async, crypto, fs, jtfs, mime, noop, path, request, xml2js, xmlParser, zlib, _,
    __slice = [].slice;
  ...
  Client = (function() {
    ...
    */
    ...
    Client.prototype.putBucket = function(bucket, acl, headers, cbf) {
    ...
    */
    ...
    Client.prototype.updateObjectFromFile = function(bucket, object, fileName, cbf) {
      var headers,
        _this = this;
      headers = null;
      return async.waterfall([
        function(cbf) {
          ...
          if (modified) {
            return _this.putObjectFromFile(bucket, object, fileName, headers, null, cbf);
          } else {
            return cbf(null);
          }
        }
    ...
    */
    ...
    Client.prototype.uploadLargeFile = function() {
      var args, bucket, cbf, fileName, headers, object, params, partMsgList, progress, uploadId, uploadInfos, _filetrPartMsgList, _uploadPart,
        _this = this;
      bucket = arguments[0], object = arguments[1], fileName = arguments[2], args = 4 <= arguments.length ? __slice.call(arguments, 3) : [];
      ...
      return async.waterfall([
        function(cbf) {
          ...
          complete = 0;
          return async.eachLimit(partMsgList, 5, function(partMsg, cbf) {
    ...
    */
    ...
    Client.prototype.listObjectsByFilter = function(bucket, headers, params, cbf) {
      ...
      return async.waterfall([
        function(cbf) {
          ...
          return async.eachLimit(syncFilesInfo.largeFiles, 1, function(file, cbf) {
            var object;
            object = targetPath + file.substring(sourcePathLen);
            return this.updateLargeFileFromFile(bucket, object, file, function(err) {
              var done;
              done = true;
              if (err) {
                done = false;
    ...
    */
    ...
    Client.prototype.updateLargeFileFromFile = function(bucket, object, fileName, cbf) {
      var _this = this;
      return async.waterfall([
        function(cbf) {
          return _this.isModified(bucket, object, fileName, cbf);
          ...
          if (modified) {
            return async.waterfall([
              function(cbf) {
                ...
                return this.uploadLargeFile(bucket, object, fileName, headers, null, cbf);
              }
            ], cbf);
          } else {
            return cbf(null);
    ...
    Client.prototype.request = function(options, retryTimes, cbf) {
      ...
      if (((_ref = options.body) != null ? _ref.length : void 0) > MB_SIZE) {
